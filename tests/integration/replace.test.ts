...
describe('Replace', () => {
    ...
    describe('POST /', () => {
        ...
        it('should return 400 if format.replace is not not an object', async () => {
            body.format.replace = '';
        ...
        it('should return 400 if format.replace does not contain minimum 1 item', async () => {
            body.format['replace'] = {};
        ...
        it('should return 400 if format.replace key:value is not string', async () => {
            body.format['replace'] = {
                "key": 1
            };
        ...
        it('should return 200 if format contains only replace', async () => {
            ...
            expect(res.text).toBe(replacedText.text);
        });
